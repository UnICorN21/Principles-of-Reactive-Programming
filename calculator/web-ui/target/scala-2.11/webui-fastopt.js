...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  var jsx$2 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(namedExpressions, cbf));
  var jsx$1 = new $c_Lcalculator_Calculator$$anonfun$computeValues$1().init___sci_Map(namedExpressions);
  var this$2 = $m_sci_List$();
  return $as_sc_TraversableOnce(jsx$2.map__F1__scg_CanBuildFrom__O(jsx$1, this$2.ReusableCBFInstance$2)).toMap__s_Predef$$less$colon$less__sci_Map($m_s_Predef$().singleton$und$less$colon$less$2)
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__sci_List__D = (function(expr, references, caller) {
  _eval: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      if ($s_sc_LinearSeqOptimized$class__contains__sc_LinearSeqOptimized__O__Z(this$1, name)) {
        ...
        var this$2 = caller;
        var temp$caller = new $c_sci_$colon$colon().init___O__sci_List(name, this$2);
        expr = temp$expr;
        caller = temp$caller;
        continue _eval
      }
      ...
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__sci_List__D(a, references, caller) + this.eval__Lcalculator_Expr__sci_Map__sci_List__D(b, references, caller))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__sci_List__D(a$2, references, caller) - this.eval__Lcalculator_Expr__sci_Map__sci_List__D(b$2, references, caller))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__sci_List__D(a$3, references, caller) * this.eval__Lcalculator_Expr__sci_Map__sci_List__D(b$3, references, caller))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__sci_List__D(a$4, references, caller) / this.eval__Lcalculator_Expr__sci_Map__sci_List__D(b$4, references, caller))
    } else {
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    $m_Lcalculator_Signal$();
    var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, name$1, expr$1) {
      return (function() {
        var jsx$3 = $m_Lcalculator_Calculator$();
        var jsx$2 = $as_Lcalculator_Expr(expr$1.apply__O());
        var jsx$1 = arg$outer.namedExpressions$1$f;
        $m_sci_List$();
        var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([name$1]);
        var this$3 = $m_sci_List$();
        var cbf = this$3.ReusableCBFInstance$2;
        return jsx$3.eval__Lcalculator_Expr__sci_Map__sci_List__D(jsx$2, jsx$1, $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf)))
      })
    })(this, name, expr));
